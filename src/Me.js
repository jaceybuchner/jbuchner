  ...
  return (
    ...
    id="About" margin={10} pr={20} pl={20}>
        ...
        <Heading mb={6}>about me. <Emoji symbol="😀"/></Heading>
          ...
          <span style={{fontWeight: 'bold'}}>now:</span> Working at <Link href="https://healthy.kaiserpermanente.org/northern-california/front-door" bg={"gray.200"}>Kaiser Permanente</Link> as a Product Management Intern and helping grow the 
